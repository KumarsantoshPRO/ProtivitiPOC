			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mispmaruti-display": {
								"semanticObject": "mispmaruti",
								"action": "display",
								"description": "Application for MIS-P Admin",
								"title": "misp-admin",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=misp.maruti",
									"url": sap.ui.require.toUrl("misp/maruti")
								}
							}
						}
					}
