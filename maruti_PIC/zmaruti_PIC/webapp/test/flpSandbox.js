		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Maruti Suzuki",
									"targetURL": "#comzmarutipic-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comzmarutipic-display": {
								"semanticObject": "comzmarutipic",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.zmarutipic",
									"url": sap.ui.require.toUrl("com/zmarutipic")
								}
							}
						}
					}
